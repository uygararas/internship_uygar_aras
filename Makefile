...
# Project:  buttonPush.pro
# Template: app
# Command: /opt/homebrew/bin/qmake -o Makefile buttonPush.pro
#############################################################################
...
INCPATH       = -I. -I/opt/homebrew/lib/QtWidgets.framework/Headers -I/opt/homebrew/lib/QtGui.framework/Headers -I/opt/homebrew/lib/QtSerialPort.framework/Headers -I/opt/homebrew/lib/QtCore.framework/Headers -I. -I/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX13.0.sdk/System/Library/Frameworks/OpenGL.framework/Headers -I/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX13.0.sdk/System/Library/Frameworks/AGL.framework/Headers -I. -I/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX13.0.sdk/System/Library/Frameworks/OpenGL.framework/Headers -I/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX13.0.sdk/System/Library/Frameworks/AGL.framework/Headers -I/opt/homebrew/share/qt/mkspecs/macx-clang -F/opt/homebrew/lib
...
DISTDIR = /Users/uygararas/Desktop/ArduinoFile/buttonPush/.tmp/buttonPush1.0.0
LINK          = /opt/homebrew/bin/x86_64-w64-mingw32-g++
LIBS          = $(SUBLIBS) -F/opt/homebrew/lib -framework QtWidgets -framework QtGui -framework AppKit -framework ImageIO -framework Metal -framework QtSerialPort -framework QtCore -framework IOKit -framework DiskArbitration -framework AGL -framework OpenGL   
...
SOURCES       = gloweffect.cpp \
		ledwidget.cpp \
		main.cpp \
		dialog.cpp moc_dialog.cpp \
		moc_ledwidget.cpp
OBJECTS       = gloweffect.o \
		ledwidget.o \
		main.o \
		dialog.o \
		moc_dialog.o \
...
DIST          = /opt/homebrew/share/qt/mkspecs/features/spec_pre.prf \
		...
		buttonPush.pro dialog.h \
		gloweffect.h \
		ledwidget.h gloweffect.cpp \
		ledwidget.cpp \
		main.cpp \
		dialog.cpp
...
EXPORT__QMAKE_STASH_ = /Users/uygararas/Desktop/ArduinoFile/buttonPush/.qmake.stash
...
Makefile: buttonPush.pro /opt/homebrew/share/qt/mkspecs/macx-clang/qmake.conf /opt/homebrew/share/qt/mkspecs/features/spec_pre.prf \
		/opt/homebrew/share/qt/mkspecs/features/device_config.prf \
		/opt/homebrew/Cellar/qt/6.5.1_2/share/qt/mkspecs/common/unix.conf \
		/opt/homebrew/Cellar/qt/6.5.1_2/share/qt/mkspecs/common/mac.conf \
		/opt/homebrew/Cellar/qt/6.5.1_2/share/qt/mkspecs/common/macx.conf \
		...
		/opt/homebrew/lib/QtSerialPort.framework/Resources/QtSerialPort.prl \
		/opt/homebrew/lib/QtCore.framework/Resources/QtCore.prl
	$(QMAKE) -o Makefile buttonPush.pro
...
buttonPush.app/Contents/Info.plist: 
	...
	@plutil -convert xml1 -o - /opt/homebrew/share/qt/mkspecs/macx-clang/Info.plist.app | sed -e "s,@SHORT_VERSION@,1.0,g" -e "s,\$${QMAKE_SHORT_VERSION},1.0,g" -e "s,@FULL_VERSION@,1.0.0,g" -e "s,\$${QMAKE_FULL_VERSION},1.0.0,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" -e "s,@BUNDLEIDENTIFIER@,cs202.buttonPush,g" -e "s,\$${PRODUCT_BUNDLE_IDENTIFIER},cs202.buttonPush,g" -e "s,\$${MACOSX_DEPLOYMENT_TARGET},12.0,g" -e "s,\$${IPHONEOS_DEPLOYMENT_TARGET},,g" -e "s,\$${TVOS_DEPLOYMENT_TARGET},,g" -e "s,\$${WATCHOS_DEPLOYMENT_TARGET},,g" -e "s,\$${IOS_LAUNCH_SCREEN},LaunchScreen,g" -e "s,@ICON@,,g" -e "s,\$${ASSETCATALOG_COMPILER_APPICON_NAME},,g" -e "s,@EXECUTABLE@,buttonPush,g" -e "s,@LIBRARY@,buttonPush,g" -e "s,\$${EXECUTABLE_NAME},buttonPush,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" >buttonPush.app/Contents/Info.plist
...
distdir: FORCE
	...
	$(COPY_FILE) --parents dialog.h gloweffect.h ledwidget.h $(DISTDIR)/
	$(COPY_FILE) --parents gloweffect.cpp ledwidget.cpp main.cpp dialog.cpp $(DISTDIR)/
...
moc_predefs.h: /opt/homebrew/share/qt/mkspecs/features/data/dummy.cpp
	/opt/homebrew/bin/x86_64-w64-mingw32-g++ -pipe -stdlib=libc++ -O2 -std=gnu++1z $(EXPORT_ARCH_ARGS) -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX13.0.sdk -mmacosx-version-min=12.0 -Wall -Wextra -dM -E -o moc_predefs.h /opt/homebrew/share/qt/mkspecs/features/data/dummy.cpp

compiler_moc_header_make_all: moc_dialog.cpp moc_ledwidget.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_dialog.cpp moc_ledwidget.cpp
moc_dialog.cpp: dialog.h \
		/opt/homebrew/lib/QtWidgets.framework/Headers/QDialog \
		/opt/homebrew/lib/QtWidgets.framework/Headers/qdialog.h \
		/opt/homebrew/lib/QtSerialPort.framework/Headers/QSerialPort \
		/opt/homebrew/lib/QtSerialPort.framework/Headers/qserialport.h \
		/opt/homebrew/lib/QtSerialPort.framework/Headers/QSerialPortInfo \
		/opt/homebrew/lib/QtSerialPort.framework/Headers/qserialportinfo.h \
	...
	/opt/homebrew/share/qt/libexec/moc $(DEFINES) --include /Users/uygararas/Desktop/ArduinoFile/buttonPush/moc_predefs.h -I/opt/homebrew/share/qt/mkspecs/macx-clang -I/Users/uygararas/Desktop/ArduinoFile/buttonPush -I/opt/homebrew/lib/QtWidgets.framework/Headers -I/opt/homebrew/lib/QtGui.framework/Headers -I/opt/homebrew/lib/QtSerialPort.framework/Headers -I/opt/homebrew/lib/QtCore.framework/Headers -I/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX13.0.sdk/usr/include/c++/v1 -I/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/lib/clang/14.0.0/include -I/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX13.0.sdk/usr/include -I/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/include -F/opt/homebrew/lib dialog.h -o moc_dialog.cpp

moc_ledwidget.cpp: ledwidget.h \
		/opt/homebrew/lib/QtWidgets.framework/Headers/QWidget \
		/opt/homebrew/lib/QtWidgets.framework/Headers/qwidget.h \
		moc_predefs.h \
		/opt/homebrew/share/qt/libexec/moc
	/opt/homebrew/share/qt/libexec/moc $(DEFINES) --include /Users/uygararas/Desktop/ArduinoFile/buttonPush/moc_predefs.h -I/opt/homebrew/share/qt/mkspecs/macx-clang -I/Users/uygararas/Desktop/ArduinoFile/buttonPush -I/opt/homebrew/lib/QtWidgets.framework/Headers -I/opt/homebrew/lib/QtGui.framework/Headers -I/opt/homebrew/lib/QtSerialPort.framework/Headers -I/opt/homebrew/lib/QtCore.framework/Headers -I/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX13.0.sdk/usr/include/c++/v1 -I/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/lib/clang/14.0.0/include -I/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX13.0.sdk/usr/include -I/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/include -F/opt/homebrew/lib ledwidget.h -o moc_ledwidget.cpp
...
ui_dialog.h: dialog.ui \
	...
	/opt/homebrew/share/qt/libexec/uic dialog.ui -o ui_dialog.h
...
gloweffect.o: gloweffect.cpp gloweffect.h \
		/opt/homebrew/lib/QtWidgets.framework/Headers/QGraphicsEffect \
		/opt/homebrew/lib/QtWidgets.framework/Headers/qgraphicseffect.h \
		/opt/homebrew/lib/QtGui.framework/Headers/QPainter \
		/opt/homebrew/lib/QtGui.framework/Headers/qpainter.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o gloweffect.o gloweffect.cpp

ledwidget.o: ledwidget.cpp ledwidget.h \
		/opt/homebrew/lib/QtWidgets.framework/Headers/QWidget \
		/opt/homebrew/lib/QtWidgets.framework/Headers/qwidget.h \
		/opt/homebrew/lib/QtGui.framework/Headers/QPainter \
		/opt/homebrew/lib/QtGui.framework/Headers/qpainter.h \
		...
		/opt/homebrew/lib/QtWidgets.framework/Headers/qlabel.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o ledwidget.o ledwidget.cpp
...
moc_ledwidget.o: moc_ledwidget.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_ledwidget.o moc_ledwidget.cpp
